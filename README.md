...
시로 AI 버튜버 실행 프로그램의 **설치·실행·UI·방송 연동** 가이드입니다.

[[TIP("시작하기")]]
처음이시면 **01. 시작하기**부터 읽어 주세요.
[[/TIP]]
...
![Hugging Face 다운로드](https://static.wikidocs.net/images/page/372487/hf_siro_vtuber_bucket.png)
