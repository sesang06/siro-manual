...
Live2D 표시·자막·오디오 재생은 Unity 클라이언트가 담당합니다. [[07. Unity 클라이언트|Unity 클라이언트]] 절차에 따라 **siro-launcher**를 준비하세요.

## 4. 첫 실행

[[06. 첫 실행|첫 실행]]으로 진행합니다.

## 업데이트

새 zip을 받아 기존 폴더를 덮어쓰기 전에 `setting_doc` 백업을 권장합니다. [[12. 설정 관리|설정 관리]]의 내보내기 기능을 사용할 수 있습니다.
