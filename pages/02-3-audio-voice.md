...
Unity 캐릭터 **볼륨**, **입 움직임 감도**, **입 부드러움**을 조절합니다. Unity가 연결된 상태면 **실행 중에도** 슬라이더 변경이 바로 반영됩니다.

## 실행 제어와의 연동

[[02-9. 실행 제어|실행 제어]] 패널의 「방송인이 말하는 동안 AI가 말하지 않음」「AI 발화 중 마이크 음소거」는 STT·TTS 동작과 함께 쓰입니다.
