...
![화면 캡처 패널 — AI 전달 켠 상태](../assets/ui/panel-capture-enabled.png)

[[TIP("TIP")]]
켜 두면 API 호출마다 이미지가 붙어 **과금·지연**이 늘어납니다. 계속 대화할 때 시간당 약 $1 수준까지 올라갈 수 있으니, 필요할 때만 켜세요.
[[/TIP]]
...
웹캠이 다른 프로그램에 점유되어 있으면 OBS **가상 카메라**를 만들어 「카메라」 모드에서 선택할 수 있습니다.
