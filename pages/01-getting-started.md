...
5. **오디오·음성** 탭 — 마이크, STT, TTS 모듈을 설정합니다. ([[02-3. 오디오·음성|오디오·음성]] 참고)
...
우측 **실행 제어**에서 **프로그램 시작**으로 백엔드를 켭니다. 자세한 설명은 [[02-9. 실행 제어|실행 제어]] 페이지를 보세요.
...
Live2D 모델·표정·의상은 [[02-7. 라투디|라투디]] 탭에서 설정합니다.

## 업데이트

새 zip을 받아 기존 폴더를 덮어쓰기 전에 `setting_doc` 백업을 권장합니다. [[02-8. 설정 관리|설정 관리]]의 내보내기 기능을 사용할 수 있습니다.
